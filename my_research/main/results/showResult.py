...
plot_csv_data_p('plsReddit.csv', 'img/plsReddit.jpg', 'plsReddit0.csv', 1)
...
plot_csv_data('stfsReddit.csv', 'img/stfsReddit.jpg', 'stfsReddit0.csv', 4)
plot_csv_data('udvReddit.csv', 'img/udvReddit.jpg', 'udvReddit0.csv', 5)
plot_csv_data('cdvReddit.csv', 'img/cdvReddit.jpg', 'cdvReddit0.csv', 6)


plot_csv_data_p('plsTwitter.csv', 'img/plsTwitter.jpg', 'plsTwitter0.csv', 1)
plot_csv_data('disaggTwitter.csv', 'img/disaggTwitter.jpg', 'disaggTwitter0.csv', 2)
plot_csv_data('gpplsTwitter.csv', 'img/gpplsTwitter.jpg', 'gpplsTwitter0.csv', 3)
